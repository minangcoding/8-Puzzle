...
algorithmOptions = ["A* (algoritma)","Best-First (algoritma)"]
...
### Final state input
report_rect = pygame.Rect((0, 0), (0, 0))
...
set_final_button = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((0, 0), (0, 0)),
                                                text='',
                                                manager=manager)
### shuffle button
...
puzzle.initialize()
algorithm = "Best-First (algoritma)"
        ...
        if event.type == pygame.USEREVENT:
            if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                if event.ui_element == shuffle_button:
                    ...
                    Info_msg = '<b>Puzzle8<br><br>Tentang Kami:</b><br>Refido Arjunal Akmal (2010130013)<br>M Aldy Fadillah (2010130017)<br>Chiekal Mulia (2010130005)'
                    ...
                    if algorithm == "Best-First (algoritma)":
                        moves = puzzle.bestFirst()
                        tempo = "{temp: .2f} seconds".format(temp = puzzle.lastSolveTime)
